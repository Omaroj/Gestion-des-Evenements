...
<html>
<head>
    <title>Gestion des Evénements</title>
...
<body>
    <div class="container my-4">
        ...
        <h2 class="text-center mb-4">Gestion des Evénements</h2>
        ...
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0">Ajouter ou Modifier un événement</h5>
            </div>
            <div class="card-body">
        ...
        <h3 class="mb-3">Événements Existants</h3>
