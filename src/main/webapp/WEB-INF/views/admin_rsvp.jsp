    ...
    <div class="container my-4">
        ...
        <div class="d-flex justify-content-start mb-3">
            <a href="${pageContext.request.contextPath}/admin/dashboard" class="btn btn-secondary">
                <i class="fas fa-arrow-left"></i> Retour au tableau de bord d'admin
            </a>
        </div>
                            ...
                            <td>
                                <form action="<%= request.getContextPath() %>/admin/updateStatus" method="post" class="form-inline">
                                    ...
                                    <select name="status" class="custom-select mr-2">
                                        <option value="Pending" <%= "Pending".equalsIgnoreCase(rsvp.getStatus()) ? "selected" : "" %>>En attente</option>
                                        <option value="Confirmed" <%= "Confirmed".equalsIgnoreCase(rsvp.getStatus()) ? "selected" : "" %>>Confirmé</option>
                                        <option value="Cancelled" <%= "Cancelled".equalsIgnoreCase(rsvp.getStatus()) ? "selected" : "" %>>Annulé</option>
                                    </select>
