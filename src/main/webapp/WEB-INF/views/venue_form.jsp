...
<body>
    <div class="container my-4">
        ...
        <h2 class="text-center mb-4">Gestion des Lieux</h2>

        <!-- Venue Form -->
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <h5 class="card-title mb-0">Ajouter ou Modifier un lieu</h5>
            </div>
            <div class="card-body">
                <form action="${pageContext.request.contextPath}/admin/saveVenue" method="post">
                    ...
                    <button type="submit" class="btn btn-success">Enregistrer le Lieu</button>
                </form>
            </div>
        </div>

        <!-- Existing Venues Section -->
        <h3 class="mb-3">Lieux Existants</h3>
        <div class="table-responsive">
            <table class="table table-bordered table-hover">
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            <td colspan="4" class="text-center">Aucun lieu disponible.</td>
                        </tr>
                    <%
                        }
                    %>
